...
5. Separate work Codex can complete now from decisions awaiting Philip.
6. Update project-office records after meaningful work.
7. Prefer separate branches and pull requests for planning, implementation, formatting, and QA.

## Required output
- Current phase
- Recommended specialist sequence
- Work permitted now
- Decisions awaiting Philip
